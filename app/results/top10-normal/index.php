...
<div class="p-1">
    <table class="table table-bordered result">
        ...
        <tr class="table-secondary">
            <?php for($i=0; $i<sizeof(EVENTS); $i++) { ?>
                <th class="text-center text-primary" style="width: 125px;">Final<br>Rank</th>
                <th class="text-center text-primary" style="width: 125px;">Rank<br>Inverse</th>
        ...
        <tr class="table-secondary">
            <?php for($i=0; $i<sizeof(EVENTS); $i++) { ?>
                <th colspan="2" class="bb bl" style="text-align: right"><span class="opacity-75">Rating Average</span></th>
            <?php } ?>
        </tr>
        </thead>
        <tbody>
        ...
        foreach($result as $team_key => $team) { ?>
            <tr data-team-id="<?= $team['info']['id'] ?>"<?= $team['title'] !== '' ? ' class="table-warning"' : '' ?>>
                ...
                <td rowspan="2" class="br bb">
                    <p class="team-name mt-0 me-0 mb-1 ms-0 text-subtitle-2 text-uppercase font-weight-bold" style="line-height: 1.2"><b><?= $team['info']['name'] ?></b></p>
                    <p class="team-location mb-0" style="line-height: 1; opacity: 0.8"><small><b><?= $team['info']['location'] ?></b></small></p>
            ...
            if(tr1.hasClass('table-warning')) {
                ...
                const trWinner = `
                        <tr data-team-id="${tr1.attr('data-team-id')}">
                            ...
                            <td>
                                <p class="team-name mt-0 me-0 mb-1 ms-0 text-subtitle-2 text-uppercase font-weight-bold" style="line-height: 1.2"><b>${tr1.find('.team-name').text()}</b></p>
                                <p class="team-location mb-0" style="line-height: 1; opacity: 0.8"><small><b>${tr1.find('.team-location').text()}</b></small></p>
                                <p class="team-meta mb-0" style="line-height: 1; opacity: 0.85"><small>${tr1.find('.team-meta').text()}</small></p>
                            </td>
                        </tr>
                    `;
