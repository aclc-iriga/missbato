                                                    ...
                                                    <template #item="{ element, index }">
                                                        <div class="d-flex align-center py-1" style="height: 76px; column-gap: 8px;">
                                                            ...
                                                            <div class="overflow-hidden">
                                                                ...
                                                                <p class="mb-0" v-if="element.meta.trim() !== ''" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; line-height: 1; opacity: 0.85; width: 100%;">
                                                                    <small>{{ element.meta }}</small>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </template>
			...
			<tbody>
				...
				>
                    ...
                    >
                        ...
                        <p class="mb-0" v-if="team.meta.trim() !== ''" style="line-height: 1; opacity: 0.9"><small>{{ team.meta }}</small></p>
                    </td>
					<td
						v-for="(criterion, criterionIndex) in criteria"
						:key="criterion.id"
